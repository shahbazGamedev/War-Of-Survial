...
public class AI_PlayerHealth : MonoBehaviour {
	...
	AI_PlayerMovement playerMovement;                              // Reference to the player's movement.
	AI_PlayerShooting playerShooting;                              // Reference to the PlayerShooting script.
	...
	void Start()
	{
		...
		playerMovement = GetComponent <AI_PlayerMovement> ();
		playerShooting = GetComponentInChildren <AI_PlayerShooting> ();
